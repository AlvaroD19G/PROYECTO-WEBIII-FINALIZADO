...
form.addEventListener('submit', function(event) {
    ...
    axios.post('http://mascotas2.freesite.online/WebIIIVeterinara/Controlador/citasController.php?accion=insertar', eventData, {
        headers: {
...
function cargarMascotas() {
    axios.get('http://mascotas2.freesite.online/WebIIIVeterinara/Controlador/mascotasController.php?accion=listar')
    .then(response => {
